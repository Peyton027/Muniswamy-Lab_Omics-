...
OUTPUT_PDF = "sodium_individual_heatmap.pdf"
COLOR_LIMIT = 2.0
...
def main():
    ...
    # Keep only sodium-related genes.
    df = df[
    ...
    # Sort sodium genes by subcategory, then gene name.
    ...
    title_ax.text(
        0.5,
        0.70,
        "Person-by-Person Sodium Gene Expression Heatmap",
        ha="center",
        va="center",
        fontsize=16,
        fontweight="bold"
    ...
    title_ax.text(
        0.5,
        0.20,
        f"All retained sodium-annotated genes (n = {n_genes}) • "
