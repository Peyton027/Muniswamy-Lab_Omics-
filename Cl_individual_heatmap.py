...
OUTPUT_PDF = "chloride_individual_heatmap.pdf"
COLOR_LIMIT = 2.0
...
def main():
    ...
    # Keep only chloride-related genes.
    df = df[
    ...
    # Sort chloride genes by subcategory, then gene name.
    ...
    title_ax.text(
        0.5,
        0.70,
        "Person-by-Person Chloride Gene Expression Heatmap",
        ha="center",
        va="center",
        fontsize=16,
        fontweight="bold"
    ...
    title_ax.text(
        0.5,
        0.20,
        f"All retained chloride-annotated genes (n = {n_genes}) • "
